        ...
        <div class="col-4">
            <form method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="s_name" value="{{ $semester->s_name }}" id="exampleInputEmail1" placeholder="Tên học kỳ" aria-describedby="emailHelp">
                ...
                <div class="mb-3">
                    ...
                    <input type="date" class="form-control" value="{{ $semester->s_start }}" required name="s_start" id="exampleInputEmail1"  aria-describedby="emailHelp">
                </div>
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">Ngày kết thúc</label>
                    <input type="date" class="form-control" value="{{ $semester->s_stop }}" required name="s_stop" id="exampleInputEmail1"  aria-describedby="emailHelp">
                </div>
