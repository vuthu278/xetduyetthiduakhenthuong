        ...
        <div class="list-group list-group-flush">
            @foreach(config('sidebar_admin') as $item)
                @if (get_data_user('admins','level') != 0 )
                    @if (in_array($item['route'], routeRuleAdm()))
                    <a class="list-group-item list-group-item-action {{ in_array(Request::segment(2), $item['segment']) ? 'active' : '' }}
                    ...
                    <ul class="navbar-nav ms-auto mt-2 mt-lg-0">
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                <li>
                                    <a class="dropdown-item" href="{{ route('get_admin.logout') }}">
