            ...
            <form method="POST" action="{{ route('user.update_password') }}" autocomplete="off">
                ...
                <div class="row">
                    ...
                    <div class="mb-3 col-sm-6">
                        ...
                        <input type="password" class="form-control" name="password_confirmation" id="password_confirmation" placeholder="*******" required aria-describedby="emailHelp">
                        @if ($errors->has('password_confirmation'))
                            <div id="emailHelp" class="form-text text-danger">{{ $errors->first('password_confirmation') }}</div>
                        @endif
                    </div>
                </div>
